...
let testMetrics = {
    ...
    qualityFailures: 0,
    hallucinations: 0,
    instructionFollowingFailures: 0,
    inconsistencies: 0,
...
export const recordRequest = (success, _duration) => {
...
export const recordInstructionFollowingFailure = () => {
    testMetrics.instructionFollowingFailures++;
};
...
export const evaluateQualitySLO = () => {
    ...
    const hallucination_rate = testMetrics.totalRequests > 0 
        ...
        : 0;
    const instruction_following = testMetrics.totalRequests > 0
        ? 1 - (testMetrics.instructionFollowingFailures / testMetrics.totalRequests)
        : 1;
