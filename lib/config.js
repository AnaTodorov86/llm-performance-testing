...
// ---------------------------------------------------------------------------
// Environment-aware thresholds (Google SDET standard)
// ---------------------------------------------------------------------------

export const THRESHOLDS_DEFAULT = {
    'llm_errors':  [`rate<${thresholds.errorRate}`],
    'llm_latency': [`p(95)<${thresholds.p95Latency}`],
    'llm_success': [`rate>${thresholds.successRate}`],
};

export const THRESHOLDS_STRESS = {
    'llm_errors':  [`rate<${thresholds.errorRate * 2}`],
    'llm_latency': [`p(95)<${thresholds.p95Latency * 1.5}`],
    'llm_success': [`rate>${thresholds.successRate - 0.05}`],
};
